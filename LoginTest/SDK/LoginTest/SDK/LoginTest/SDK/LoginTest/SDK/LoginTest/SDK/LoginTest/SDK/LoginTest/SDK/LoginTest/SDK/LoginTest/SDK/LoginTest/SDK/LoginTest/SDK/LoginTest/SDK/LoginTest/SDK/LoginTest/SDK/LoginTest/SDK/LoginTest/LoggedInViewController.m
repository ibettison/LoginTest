...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    // Load the property list into an NSDictionary
    self.menuItems = [[NSDictionary alloc] initWithContentsOfFile:filePath];
    self.menuList = [NSArray arrayWithArray:[self.menuItems objectForKey:@"MenuItems"]];
    NSLog(@"%@", self.menuList);
